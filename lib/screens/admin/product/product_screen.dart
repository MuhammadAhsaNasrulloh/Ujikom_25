...
import 'package:waixilaundry/screens/admin/product/edit_product.dart';
...
class _ProductScreenState extends State<ProductScreen> {
    ...
    setState(() {
      if (searchQuery.isEmpty) {
        ...
        filteredProducts = products.where((product) {
          ...
          final category =
              product['kategori']?['kategori'].toString().toLowerCase() ?? '';
  ...
  Widget _buildProductCard(dynamic product) {
    return InkWell( // Add this wrapper for tap functionality
      onTap: () {
        Navigator.push(
          context,
          MaterialPageRoute(
          ...
          // Refresh the products list when returning from edit screen
          if (value == true) {
            fetchProducts();
          }
        });
              ...
              Expanded(
                child: Column(
                  ...
                  children: [
                    ...
                    _buildInfoRow(
                        'Kategori', product['kategori']?['kategori'] ?? 'N/A'),

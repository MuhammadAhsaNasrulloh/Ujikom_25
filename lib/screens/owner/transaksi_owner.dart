...
class TransaksiOwner extends StatefulWidget {
  const TransaksiOwner({super.key});

  @override
  State<TransaksiOwner> createState() => _TransaksiOwnerState();
}

class _TransaksiOwnerState extends State<TransaksiOwner> {
                      ...
                      child: InkWell(
                        onTap: () {
                          Navigator.push(
                            ...
                            MaterialPageRoute(
                              builder: (context) =>
                                  TransactionDetailOwner(transaksi: transaksi),
                            ),
                          );
                        },
                        borderRadius: BorderRadius.circular(12),
